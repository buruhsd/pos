...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{asset('shop/assets/images/icons/favicon.ico')}}">

    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="{{asset('shop/assets/css/bootstrap.min.css')}}">

    <!-- Main CSS File -->
    <link rel="stylesheet" href="{{asset('shop/assets/css/style.min.css')}}">
</head>
<body>
            ...
            <div class="header-top">
                <div class="container">
                    <div class="header-left header-dropdowns">
                        ...
                        <div class="header-dropdown">
                            <a href="#"><img src="{{asset('shop/assets/images/flags/en.png')}}" alt="England flag">ENGLISH</a>
                            <div class="header-menu">
                                <ul>
                                    <li><a href="#"><img src="{{asset('shop/assets/images/flags/en.png')}}" alt="England flag">ENGLISH</a></li>
                                    <li><a href="#"><img src="{{asset('shop/assets/images/flags/fr.png')}}" alt="France flag">FRENCH</a></li>
                                </ul>
                            </div><!-- End .header-menu -->
                        </div><!-- End .header-dropown -->
                ...
                <div class="container">
                    <div class="header-left">
                        <a href="index.html" class="logo">
                            <img src="{{asset('shop/assets/images/logo.png')}}" alt="Porto Logo">
                        </a>
                    </div><!-- End .header-left -->
                                ...
                                <div class="dropdownmenu-wrapper">
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="product.html" class="product-image">
                                                    <img src="{{asset('shop/assets/images/products/cart/product-1.jpg')}}" alt="product">
                                                </a>
                                                <a href="#" class="btn-remove" title="Remove Product"><i class="icon-cancel"></i></a>
                                            </figure>
                                        </div><!-- End .product -->
                                        ...
                                        <div class="product">
                                            ...
                                            <figure class="product-image-container">
                                                <a href="product.html" class="product-image">
                                                    <img src="{{asset('shop/assets/images/products/cart/product-2.jpg')}}" alt="product">
                                                </a>
                                                <a href="#" class="btn-remove" title="Remove Product"><i class="icon-cancel"></i></a>
                                            </figure>
                                        </div><!-- End .product -->
                    ...
                    <div class="col-lg-9">
                        <div class="home-slider owl-carousel owl-carousel-lazy owl-theme owl-theme-light">
                            <div class="home-slide">
                                <div class="owl-lazy slide-bg" data-src="{{asset('shop/assets/images/slider/slide-1.jpg')}}"></div>
                            ...
                            <div class="home-slide">
                                <div class="owl-lazy slide-bg" data-src="{{asset('shop/assets/images/slider/slide-2.jpg')}}"></div>
                            ...
                            <div class="home-slide">
                                <div class="owl-lazy slide-bg" data-src="{{asset('shop/assets/images/slider/slide-3.jpg')}}"></div>
                                <div class="home-slide-content">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="banner banner-image">
                                    <a href="#">
                                        <img src="{{asset('shop/assets/images/banners/banner-1.jpg')}}" alt="banner">
                                    </a>
                                </div><!-- End .banner -->
                            </div><!-- End .col-md-4 -->
                        ...
                        <div class="home-featured-products owl-carousel owl-theme owl-dots-top">
                            <div class="product">
                                <figure class="product-image-container">
                                    <a href="product.html" class="product-image">
                                        <img src="{{asset('shop/assets/images/products/home-featured-1.jpg')}}" alt="product">
                                    </a>
                            ...
                            <div class="col-6 col-md-4">
                                <div class="product-column">
                                    ...
                                    <div class="product product-sm">
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="{{asset('shop/assets/images/products/small/product-1.jpg')}}" alt="product">
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                            <h2 class="product-title">
                    ...
                    <aside class="sidebar-home col-lg-3 order-lg-first">
                        ...
                        <div class="widget widget-banners">
                            <div class="widget-banners-slider owl-carousel owl-theme">
                                <div class="banner banner-image">
                                    <a href="#">
                                        <img src="{{asset('shop/assets/images/banners/banner-sidebar.jpg')}}" alt="banner">
                                    </a>
                                </div><!-- End .banner -->

                                <div class="banner banner-image">
                                    <a href="#">
                                        <img src="{{asset('shop/assets/images/banners/banner-sidebar-2.jpg')}}" alt="banner">
                                    </a>
                                </div><!-- End .banner -->
                            ...
                            <div class="widget-testimonials-slider owl-carousel owl-theme">
                                <div class="testimonial">
                                    <div class="testimonial-owner">
                                        <figure>
                                            <img src="{{asset('shop/assets/images/clients/client1.png')}}" alt="client">
                                        </figure>
                                ...
                                <div class="testimonial">
                                    <div class="testimonial-owner">
                                        <figure>
                                            <img src="{{asset('shop/assets/images/clients/client2.png')}}" alt="client">
                                        </figure>
        ...
        <footer class="footer">
            ...
            <div class="container">
                <div class="footer-bottom">
                    ...
                    <img src="{{asset('shop/assets/images/payments.png')}}" alt="payment methods" class="footer-payments">
    ...
    <!-- newslater -->
    <!-- <div class="newsletter-popup mfp-hide" id="newsletter-popup-form" style="background-image: url({{asset('shop/assets/images/newsletter_popup_bg.jpg')}})">
        <div class="newsletter-popup-content">
            <img src="{{asset('shop/assets/images/logo-black.png')}}" alt="Logo" class="logo-newsletter">
